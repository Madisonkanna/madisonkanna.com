  ...
  return (
    <PostFullContent className="post-full-content">
      <h3>💡Request for feedback
        </h3><div style={{paddingBottom: '20px',  fontStyle: 'italic'}}>If you are taking the time to read this (thank you) and have feedback, please comment below! Comments, corrections, and constructive criticism are not just welcome, but quite wanted.  </div>
